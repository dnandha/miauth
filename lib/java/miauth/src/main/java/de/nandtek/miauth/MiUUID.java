...
public class MiUUID {
    public static final UUID NAME = UUID.fromString("00002a00-0000-1000-8000-00805f9b34fb");
    ...
    public static final UUID KEY = UUID.fromString("00000014-0000-1000-8000-00805f9b34fb");
}
